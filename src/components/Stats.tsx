...
const stats = [
  { value: 25000, suffix: "+", desc: "Students Enrolled in Tertiary Institutions" },
  { value: 15, suffix: "", desc: "Tertiary Institutions Under Management" },
  { value: 500, suffix: "+", desc: "Academic Programs Offered" },
  { value: 2000, suffix: "+", desc: "Faculty Members & Staff" },
];
